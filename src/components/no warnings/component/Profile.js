    ...
    return (
        <div className="lkprofile">
            ...
            <div className="lkprofile-keynote-grid">
                {conference.keynoteSpeakers.map((val,keynote) =>(
                    <div className="lkprofile-keynote" key={keynote}>
            ...
            <div className="lkprofile-guest-grid">
                ...
                {conference.guestSpeakers.map((val,guest) =>(
                <div className="lkprofile-guest" key={guest}>
